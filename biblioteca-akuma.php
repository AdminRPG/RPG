...
<div class="wrap"><section class="reveal"><div class="shead"><h1>Biblioteca akuma no mi</h1><span class="code">// catálogo de frutas</span><span class="rule"></span></div></section>
