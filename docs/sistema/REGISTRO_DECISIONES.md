...
- **D4.8 (interpretación, pendiente de confirmación):** «más de 2 unidades exige rango alto o un imperio» (16.7) → cúspide de facción (`es_cuspide`) **o** nivel de personaje ≥ 30 (imperio en ciernes).
