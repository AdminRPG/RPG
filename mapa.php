 ...
 *
 * PRUEBA / PROTOTIPO — las descripciones de islas de relleno son provisionales
 * y se sustituirán por el lore canónico de Eternal-Sistema/docs/03-MUNDO/ISLAS.md.
 */
define('IN_MYBB', 1);
define('THIS_SCRIPT', 'mapa.php');
require_once './global.php';
require_once MYBB_ROOT . 'inc/ope_rol/mundo/islas_cat.php';

$bburl  = htmlspecialchars_uni($mybb->settings['bburl']);
$bbname = htmlspecialchars_uni($mybb->settings['bbname']);

$islas_cat = function_exists('ope_islas_catalogo') ? ope_islas_catalogo() : array();
$macros    = function_exists('ope_islas_macro_list') ? ope_islas_macro_list() : array();
