...
require_once dirname(__DIR__) . '/inc/gbe_rol_mundo.php';
...
$periodico = <<<'HTML'
<section class="gbe-per-lead">
  <h2>Un mes en calma: el mundo respira entre feria y marea</h2>
  <figure class="gbe-per-figwide" data-img="portada"><figcaption>Puerto bullicioso al atardecer: mercantes descargando, gaviotas y el faro encendido.</figcaption></figure>
...
<section class="gbe-per-sec">
  ...
  <aside class="gbe-per-aside"><h4>Se dice en los muelles</h4><p>Que la flota pirata busca menos saquear que asentarse. Que el oficial al mando de la base no piensa ceder ni un palmo de agua. Rumores, por ahora.</p></aside>
</section>

<section class="gbe-per-sec">
  <h3>Reportaje · La vida vuelve al South Blue</h3>
  <div class="gbe-per-longread">
    ...
    <blockquote class="gbe-per-pull">«El mar nos quitó el puerto; nosotros se lo devolvemos, tabla a tabla.»</blockquote>
...
<section class="gbe-per-sec">
  ...
  <div class="gbe-per-ads">
    <div class="gbe-per-ad">
      <span class="gbe-per-ad-tag">Negocio</span>
    ...
    <div class="gbe-per-ad">
      <span class="gbe-per-ad-tag">Se vende</span>
    ...
    <div class="gbe-per-ad">
      <span class="gbe-per-ad-tag">Se busca tripulación</span>
    ...
    <div class="gbe-per-ad gbe-per-ad--wanted">
      <span class="gbe-per-ad-tag">Se busca</span>
      <h4>«Dedos Rápidos» Molt</h4>
      <figure class="gbe-per-fig" data-img="wanted-molt"><figcaption>Vivo o muerto</figcaption></figure>
...
<section class="gbe-per-sec">
  ...
  <div class="gbe-per-longread">
    ...
    <aside class="gbe-per-aside"><h4>Firma</h4><p>— El Viejo Faro, cronista errante de <i>Eternal News</i>.</p></aside>
  </div>
</section>
HTML;
...
$res = gbe_rol_mv_publicar($ciclo_id, $parsed, $raw);
if (empty($res['ok'])) {
