<?php
/**
 * Migracion: tablas de mensajes directos y alertas.
...
// -- Tabla de mensajes directos (hilos de conversacion) --
$db->write_query("
    CREATE TABLE IF NOT EXISTS {$PREFIX}rol_mensajes (
        mid BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
        thread_id BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'hilo de conversacion',
        origen_pid INT UNSIGNED NOT NULL COMMENT 'pid del personaje que envia',
...
$db->write_query("
    CREATE TABLE IF NOT EXISTS {$PREFIX}rol_alertas (
        ...
        uid INT UNSIGNED NOT NULL COMMENT 'MyBB user dueno del personaje',
