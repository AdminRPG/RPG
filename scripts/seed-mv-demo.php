...
// ──────────────────────────────────────────────────────
// 6. Crear misiones completadas demo
// ──────────────────────────────────────────────────────
echo "6. Crear misiones completadas demo\n";
$db->write_query("DELETE FROM {$PREFIX}rol_mv_misiones WHERE 1=1");

$misiones = array(
    array(
        'titulo' => 'El cargamento perdido de la Marine',
        'resumen' => 'Un barco de suministros de la Marine desaparecio cerca de las islas del East Blue. Los jugadores investigaron el paradero y recuperaron parte de la carga, descubriendo una red de contrabando.',
        'zona_slug' => 'east-blue',
        'facciones' => 'marine,civil',
        'estado' => 'completada',
    ),
    array(
        'titulo' => 'La tregua de los bandidos',
        'resumen' => 'Dos clanes enemigos en una isla del West Blue amenazaban con desestabilizar la region. Mediante negociacion o combate, los jugadores lograron que firmaran una tregua.',
        'zona_slug' => 'west-blue',
        'facciones' => 'civil,cazarrecompensas',
        'estado' => 'completada',
    ),
    array(
        'titulo' => 'El mapa del Nuevo Mundo',
        'resumen' => 'Un viejo navegante poseia un mapa parcial de una ruta secreta en el Nuevo Mundo. Los jugadores le ayudaron a cambio del mapa.',
        'zona_slug' => 'new-world',
        'facciones' => 'pirata',
        'estado' => 'completada',
    ),
